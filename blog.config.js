...
const BLOG = {
  AUTHOR: '大以巴狼艾斯', // 作者
  BIO: '燃星为心, 点亮前路.', // 作者简介
  LINK: 'https://emowolf.fun', // 网站地址
  KEYWORDS: '大以巴狼艾斯, 兽装, furry', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '9da7a59a0397443eb15fc2c39272083f', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  SINCE: 1551, // e.g if leave this empty, current year will be used.
  ...
  CONTACT_EMAIL: '435570123@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/KelsAstell/', // 你的github个人主页
